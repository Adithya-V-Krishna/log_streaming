...
for i in range(0,10):
    ...
    data = {
        ...
        "reel_spent_time" : '{}'.format(decimal.Decimal(random.randrange(0, 100*(reel_length[index]+1)))/10), 
        "ad_id" : str(ad_choice),
        "ad_spent_time" : '{}'.format(decimal.Decimal(random.randrange(0, 100*(reel_length[index]+1)))/10),
